...
public class Board
{
    ...
    public bool InsufficientMaterial()
    {
        ...
        return IsKingVKing(counting) || IsKingBishopVKing(counting) ||
               ...
               IsKingBishopVKingKnight(counting);
    }
    ...
    private static bool IsKingBishopVKingKnight(Counting counting)
    {
        if (counting.TotalCount != 4)
        {
            return false;
        ...
        bool onlyMinors =
            counting.White(PieceType.Queen) == 0 && counting.Black(PieceType.Queen) == 0 &&
            counting.White(PieceType.Rook) == 0 && counting.Black(PieceType.Rook) == 0 &&
            counting.White(PieceType.Pawn) == 0 && counting.Black(PieceType.Pawn) == 0;

        if (!onlyMinors) return false;

        bool wb_bn = counting.White(PieceType.Bishop) == 1 && counting.White(PieceType.Knight) == 0 &&
                     counting.Black(PieceType.Bishop) == 0 && counting.Black(PieceType.Knight) == 1;

        bool wn_bb = counting.White(PieceType.Bishop) == 0 && counting.White(PieceType.Knight) == 1 &&
                     counting.Black(PieceType.Bishop) == 1 && counting.Black(PieceType.Knight) == 0;
